...
running-title: "IDEHA Workshop 1 Report"
author: "IOM"
...
publisher-address: |
  ...
  Nairobi \
  Kenya
required-citation: "International Organization for Migration (IOM), 2025. *Registration & Beneficiary Data Interoperability: South Sudan Workshop Report*. IOM, Juba."
copyright-year: "2025"
...
# No cover-image set, so the template falls back to a solid IOM-blue cover.
# The cover title is white with no scrim behind it, so a photo only works
# here if it is dark in the top-left; banner.jpg and the workshop photos
# are all too pale there and swallow the title.
  ...
  html:
    ...
    format-links:
      - text: PDF
        href: workshop1.pdf
        icon: file-pdf
      # Naming a format here makes Quarto filter its auto-generated list rather
      # than append to it; html is the current format, so nothing extra shows.
      - html
  iom-report-typst:
    toc: true
    toc-title: "CONTENTS"
